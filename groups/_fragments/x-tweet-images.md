...
**For live-fetched tweets** (`x_read`, main group only): each tweet has an `imagePaths` array under `/workspace/cross-agent/x-media/<slug>/img-N.jpg`. Same deal — call `Read` to view.
